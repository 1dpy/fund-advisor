...
// 风险感知打分开关 (赚钱优先·让选基"看病": 不全追高动量)
const RISK_AWARE_SCORING = true;     // 开启后实时综合分叠加截面索提诺/最大回撤风险层
const RISK_SCORE_WEIGHT = 0.15;      // 风险层权重(相对动量): 0.15=风险最多修正15%的动量分差
...
module.exports = {
  ...
  RISK_AWARE_SCORING, RISK_SCORE_WEIGHT,
};
